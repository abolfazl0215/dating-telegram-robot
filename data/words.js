const badWords = [
    // فارسی
    "کیر","خاله","سکسی","فتیش","فیتیش","حشری","هورنی","پورن","حضوری", "کص","کوص", "کون", "جنده", "حرومزاده", "حرومی", "سکس", "جقی", "جق", "ممه", "پستان",
    "کونده", "تخم", "کصکش", "کسکش", "کصخل", "کوسخل", "لاشی", "بی‌ناموس", "بی ناموس", "بی‌شرف", "بی شرف",
    ...
    "faggot", "asshole", "bastard", "nigga", "nigger", "motherfucker", "cunt", "bollocks", "jerk", 
    "cock", "dildo", "vagina", "boob", "boobs", "tits", "suck", "blowjob", "handjob", "cum", "porn",
